       ...
       for (let i = 0; i < Object.values(data['data']).length; i++) {
         ...
         function getch(e) {
            ...
            fetch(finalUrls).then((response) => response.json()).then((data) => {
                country.innerHTML = `<div class="container">
                <img src="${data[0].flags.svg}" class="img">
                <br>

               <a href="${data[0].maps.googleMaps}"> <button class="btn_maps"><img src ="./img/maps.png" class="img_map">Open in Google Maps</button></a><br>
