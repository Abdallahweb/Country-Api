    ...
    country.innerHTML = `
      <div class="container">
        ...
        <div class="buttons_map">
          <a href="${googleMapLink}" target="_blank"><button class="btn_maps"> 📌 Open in Google Maps</button></a>
          <a href="${openStreetLink}" target="_blank"><button class="btn_maps">🗺️ Open in Street Maps</button></a>
        </div>
